function pmd_ci_secrets_load_private_env() {
...
function pmd_ci_secrets_setup_gpg_key() {
    log_info "Setting up GPG release signing key..."
    local -r gpg_file=.ci/files/release-signing-key-D0BF1D737C9A1C22.asc
...
function pmd_ci_secrets_setup_ssh() {
